...
test('v1.32.4 explicit membership claim classifies public-agent capacity as deterministic non-retryable provider limit',async()=>{
  ...
  await assert.rejects(async()=>{
    try{await lc.ensureRequesterInChat('c1');}
